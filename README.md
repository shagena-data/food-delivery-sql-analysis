...
The script creates the database and orders_data table and inserts the transactional records.
...
Total revenue generated is 4.87 million.
...
Cancelled orders account for all missing customer ratings.
